...
class EditItemDialogFragment(var updateItemListener: UpdateItemDialogClickListener,
itemEntity: ItemEntity) : DialogFragment() {
  ...
  override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
    ...
    binding.dialogItemSaveBtn.setOnClickListener {
      ...
      if (newItemTitle == "") {
        ...
        val editedItem = ItemEntity(item_id = itemId, itemName = newItemTitle,
        itemQuantity = newItemQuantity, itemPrice = newItemPrice, itemPriorityId = itemPriorityId,
        itemCategoryId = itemCategoryId, itemPlaceToBuyId = itemPlaceToBuyId, itemListId = itemListId, itemIsBought = itemIsBought)
